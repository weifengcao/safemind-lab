...
4. Workload modules: deterministic workload intelligence for SOC triage and future governed workflows without hard-coding domain behavior into the core harness.
