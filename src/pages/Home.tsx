  ...
  return (
    <div className="flex flex-col">
      <SEO
        ...
        description="SafeMind Lab is a research and engineering initiative focused on building governed enterprise AI systems, agent harnesses, and real-world investigation workloads."
      />
