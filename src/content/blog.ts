...
export const blogPosts: BlogPost[] = [
  {
    slug: 'claude-skills-enterprise-adoption',
    title: 'Claude Skills and the Enterprise Architecture Question',
    excerpt: 'When Claude Skills are useful, when raw Skill files are enough, and when CTOs should move to a governed enterprise Skill catalog inside an agent harness.',
    date: '2026-05-08',
    readTime: '14 min read',
    category: 'Enterprise AI',
    url: '/blog/claude-skills-enterprise-adoption.html',
  },
  {
